...
CREATE TABLE Education.Enrollments (
    ...
    CONSTRAINT FK_Enrollment_Student FOREIGN KEY (EnrolledStudentID) REFERENCES Education.Students(StudentID),
    CONSTRAINT FK_Enrollment_CourseOffering FOREIGN KEY (EnrolledOfferingID) REFERENCES Education.CourseOfferings(OfferingID)
);